...
$outPath = "c:\Users\jabustos\Desktop\App\index_recovered.html"
...
foreach ($line in $lines) {
    if ($line -match 'File Path: `file:///c:/Users/jabustos/Desktop/App/index.html`' -or $line -match 'File Path: `file:///C:/Users/jabustos/Desktop/App/index.html`') {
        $inFile = $true
        continue
    }
